...
INSERT INTO application(id, account_id, repo_uri, repo_path, name, about, contact, version,reference) VALUES (5001, 1,'https://github.com/EMBL-EBI-TSI/cpa-instance', '/mnt/c/Work/ECP/Volumes/be_applications_folder/usr-ba053d51-b223-45ff-9d7c-a08e44a3672a/cpa-instance',	'Generic server instance', 'Generic server instance', 'gianni@ebi.ac.uk', '0.6','app-1c2f0d3f-2dea-4369-a6af-7048a720ffa5');
INSERT INTO application(id, account_id, repo_uri, repo_path, name, about, contact, version,reference) VALUES (5002, 2,'https://github.com/EMBL-EBI-TSI/cpa-redis', '/mnt/c/Work/ECP/Volumes/be_applications_folder/usr-ba053d51-b223-45ff-9d7c-a08e44a3672a/cpa-redis',	'redis', 'Redis Server instance', 'gianni@ebi.ac.uk', '0.1','app-801993bb-dfc9-48d3-b0ac-348255f45b73');
...
INSERT INTO team_shared_applications(team_id, application_id) VALUES (2, 5002);
